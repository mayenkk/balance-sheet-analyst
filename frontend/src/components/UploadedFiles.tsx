...
const UploadedFiles: React.FC = () => {
  const { data: uploadedFiles, isLoading, refetch } = useQuery('uploaded-files', pdfAPI.getUploadedFiles);
      ...
      <div className="bg-white shadow rounded-lg p-6">
        ...
        <div className="text-center py-8">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Upload a PDF file to see it listed here.
          </p>
        </div>
      </div>
    );
  ...
  return (
    <div className="bg-white shadow rounded-lg p-6">
      ...
      <div className="space-y-4">
        {uploadedFiles.files.map((file: UploadedFile) => (
